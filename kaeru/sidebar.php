<div class="blog_side">
	<figure class="blog_title"><img src="<?php echo get_template_directory_uri(); ?>/images/fig_blog_title.png" height="260" width="186" alt="かえるだより"></figure>
	...
	<ul class="side_ul fade">
		<?php wp_get_archives(array('post_type' => get_post_type($id), 'type' => 'monthly')); ?>
	</ul>
</div>